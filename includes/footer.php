      ...
      <div class="container">
        <div class="section d-flex row-gap-3 justify-content-between align-items-center">
          ...
          <div class="d-flex align-items-center">
            <a href="#" class="link para-main wow animate__animated animate__fadeInUp border-end pe-2">Privacy
              Policy</a>
            <a href="#" class="link para-main wow animate__animated animate__fadeInUp ps-2">Terms &
              Conditions</a>
          </div>
        </div>
      </div>
