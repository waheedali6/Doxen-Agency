    ...
    <div class="container">
        <div class="row g-md-5 row-gap-3">
            <div class="col-sm-12 col-lg-6">
                ...
                <h2 class="sec-hd wow animate__animated animate__fadeInUp mb-md-3 mb-sm-2">Contact Us For More
                    Information.
                </h2>
                <p class="para-main wow animate__animated animate__fadeInUp">Lorem ipsum dolor sit amet consectetur
                    ...
                    consequatur culpa similique repudiandae soluta obcaecati unde. Hic vero natus corrupti eveniet,
                    inventore
                    fugit quidem architecto distinctio perferendis sit nisi itaque, unde nulla, officiis aperiam odio
                    pariatur
            ...
            <div class="col-sm-12 col-lg-6">
              <div class="form-sec p-4 theme-bg rounded-3">
