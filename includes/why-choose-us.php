<div class="choose sec-bg-black sec-pd">
    <div class="container">
           <div
      ...
      <h2 class="sec-hd wow animate__animated animate__fadeInUp mb-md-3 text-center">Want To Work With Us?</h2>
      <p class="para-main wow animate__animated animate__fadeInUp text-center">
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus,<br> luctus nec ullamcorper mattis,
        ...
        <div class="d-flex flex-column flex-lg-row pt-4 pt-md-5 gap-3 gap-md-4">
            <div class="section card-section">
                <div
                    ...
                    <h5 class="card-title text-center wow animate__animated animate__fadeInUp pt-3">Fast Reliable Service</h5>
                    <p class="para-main wow animate__animated animate__fadeInUp m-0 text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                </div>
                <div
            ...
            <div class="section img-section">
                <img class="wow animate__animated animate__bounceInUp" src="assets\img\why-choose-us.png" alt="" class="img-fluid">
            </div>
            <div class="section card-section">
                <div
