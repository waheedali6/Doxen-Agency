<div class="choose sec-bg-black sec-pd pb-0">
    <div class="container">
        <div
        ...
        <h2 class="sec-hd wow animate__animated animate__fadeInUp mb-md-3 text-center">Crafting experiences,<br>
        ...
        <div class="d-flex flex-column flex-lg-row pt-4 pt-md-5 gap-3 gap-md-4">
            ...
            <div class="section img-section d-flex align-items-end">
                <img class="wow animate__animated animate__bounceInUp" src="assets\img\why-choose-us.png" alt=""
                    class="img-fluid">
            </div>
            <div class="section card-section">
                <div
